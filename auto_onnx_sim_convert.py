...
model_config = {
    ...
    "work_dirs/drown_stand-resnet18/latest.pth": "customized_cfg/drown_2cls/resnet18.py",
    "work_dirs/cat_dog-mobile/latest.pth": "customized_cfg/CatDog/mobilenet_v2.py",
    "work_dirs/cat_dog-resnet18/latest.pth": "customized_cfg/CatDog/resnet18.py",
    "work_dirs/cat_dog-shuffle/latest.pth": "customized_cfg/CatDog/shufflenet_v2.py"
}
